...
<head>
    ...
    <meta name="author" content="Vytautas Zaleckas">

    <title>Styrepanel - {block name="title"}{/block}</title>
    ...
    <!-- Timeline CSS -->
    <link href="{$site_url}admin/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{$site_url}admin/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="{$site_url}admin/bower_components/morrisjs/morris.css" rel="stylesheet">
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Styrepanel - {$site_name}</a>
        </div>
        <!-- /.navbar-header -->

        <ul class="nav navbar-top-links navbar-right">
            <li><a href="login.html"><i class="fa fa-gears fa-fw"></i> Global oppsett</a>
            <li><a href="{$site_url}styrepanel/logout"><i class="fa fa-sign-out fa-fw"></i> Logg ut</a>
            <!-- /.dropdown -->
        </ul>
        <!-- /.navbar-top-links -->
...
<script src="{$site_url}admin/bower_components/raphael/raphael-min.js"></script>
